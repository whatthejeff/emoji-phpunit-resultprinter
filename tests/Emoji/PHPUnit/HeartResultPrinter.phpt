--TEST--
phpunit --strict --repeat 10 -c ./_files/HeartResultPrinter.xml ./_files/ResultPrinterTest.php
--FILE--
<?php
...
$_SERVER['argv'][3] = '10';
$_SERVER['argv'][4] = '-c';
$_SERVER['argv'][5] = dirname(__FILE__) . '/_files/HeartResultPrinter.xml';
